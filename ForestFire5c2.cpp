...
// of large clusters.
// 5c uses immunity like: pIm/(1+k/kIm) or pIm/k
// 5c2 evaluates immunity as each fire element is added. this creates funny integer(L)^2 features for low values of pIm.
//
							...
							*/
							if (cStat >= burnAge and cStat < rockAge 
								...
								*centerGrid = -(*centerGrid);
								...
								if (frandImmune < (pImmune/pow(float(nBurning+dnBurning), kImmune)) ) {
